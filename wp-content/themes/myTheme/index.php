						...
						<div class="col-md-4 col-md-push-4 animation_1">
							...
							<div class="person">
								<?php if(has_post_thumbnail()) : ?>
									...
									?>" class="popup" title="<?php the_title_attribute(); ?>">
						...
						while (have_posts()) : the_post(); ?>
							...
							?>">
								...
								<div class="port_item_cont">
									<h3><?php the_title(); ?></h3>
									<?php the_excerpt(); ?>
									<a class="popup_content" href="#">Посмотреть</a>
									<div class="hidden">
	...
	<div class="section_content">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
					<form action="https://formspree.io/zinovev-pasha@mail.ru" method="post" class="main_form" target="_blank" novalidate>
