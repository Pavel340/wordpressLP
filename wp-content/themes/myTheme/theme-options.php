...
$select_options = array(
	'blue' => array(
		'value' =>	'blue',
		'label' => __( 'Синяя', 'sampletheme' )
	),
	'pink' => array(
		'value' =>	'pink',
		'label' => __( 'Розовая', 'sampletheme' )
	),
	'purple' => array(
		'value' => 'purple',
		'label' => __( 'Фиолетовая', 'sampletheme' )
	),
	'tomato' => array(
		'value' => 'tomato',
		'label' => __( 'Томатная', 'sampletheme' )
	)
);
...
function theme_options_do_page() {
	...
	?>
	<div class="wrap">
		<?php echo "<h2>" . wp_get_theme() . __( ' Настройки', 'sampletheme' ) . "</h2>"; ?>
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[phonetext]" class="regular-text" type="text" name="sample_theme_options[phonetext]" value="<?php echo $options['phonetext']; ?>" />
					</td>
				</tr>
			...
			<p class="submit">
				<input type="submit" class="button-primary" value="<?php _e( 'Сохранить настройки', 'sampletheme' ); ?>" />
			</p>
		</form>
	</div>
	<?php
